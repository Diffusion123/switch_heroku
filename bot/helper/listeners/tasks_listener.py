...
class MirrorLeechListener:
    def __init__(self, message, compress=False, extract=False, isQbit=False, isLeech=False, tag=None, select=False, seed=False, sameDir=None, rcFlags=None,
                 upDest=None, source_url=None , isYtdlp=False, isClone=False, join=False):
        if sameDir is None:
            sameDir = {}
